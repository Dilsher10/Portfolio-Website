      ...
      <div class="main-content w-100">
        ...
        <section class="pt-120 pb-120 mt-10 mt-lg-0">
          ...
          <div class="container">
            <div class="row g-5 g-md-10 mt-5">
              ...
              >
                <a href="blog_details.html" class="blog-card">
                  ...
                  <div class="pt-4 pt-md-8 px-3 px-md-5">
                    <div class="d-flex align-items-center gap-3 mb-2 mb-md-3">
                      <span class="n4-color fs-eight">June 14, 2024</span>
                      <span class="p1-color fs-eight">/</span>
              ...
              >
                <a href="blog_details.html" class="blog-card">
                  ...
                  <div class="pt-4 pt-md-8 px-3 px-md-5">
                    <div class="d-flex align-items-center gap-3 mb-2 mb-md-3">
                      <span class="n4-color fs-eight">May 22, 2024</span>
                      <span class="p1-color fs-eight">/</span>
                      <span class="n4-color fs-eight">Articles</span>
                    </div>
                    <h4 class="blog-title fs-five n5-color fw-semibold">
                      5 Great Web Development Frameworks to Learn in 2022
                    </h4>
                  </div>
                </a>
              </div>
              ...
              >
                <a href="blog_details.html" class="blog-card">
                  ...
                  <div class="pt-4 pt-md-8 px-3 px-md-5">
                    <div class="d-flex align-items-center gap-3 mb-2 mb-md-3">
                      <span class="n4-color fs-eight">July 17, 2024</span>
                      <span class="p1-color fs-eight">/</span>
                      <span class="n4-color fs-eight">Tutorials</span>
                    </div>
                    <h4 class="blog-title fs-five n5-color fw-semibold">
              ...
              >
                <a href="blog_details.html" class="blog-card">
                  ...
                  <div class="pt-4 pt-md-8 px-3 px-md-5">
                    <div class="d-flex align-items-center gap-3 mb-2 mb-md-3">
                      <span class="n4-color fs-eight">June 11, 2024</span>
                      <span class="p1-color fs-eight">/</span>
                      <span class="n4-color fs-eight">Articles</span>
                    </div>
                    <h4 class="blog-title fs-five n5-color fw-semibold">
              ...
              >
                <a href="blog_details.html" class="blog-card">
                  ...
                  <div class="pt-4 pt-md-8 px-3 px-md-5">
                    <div class="d-flex align-items-center gap-3 mb-2 mb-md-3">
                      <span class="n4-color fs-eight">March 25, 2024</span>
                      <span class="p1-color fs-eight">/</span>
                      <span class="n4-color fs-eight">Articles</span>
                    </div>
                    <h4 class="blog-title fs-five n5-color fw-semibold">
              ...
              >
                <a href="blog_details.html" class="blog-card">
                  ...
                  <div class="pt-4 pt-md-8 px-3 px-md-5">
                    <div class="d-flex align-items-center gap-3 mb-2 mb-md-3">
                      <span class="n4-color fs-eight">May 10, 2024</span>
                      <span class="p1-color fs-eight">/</span>
                      <span class="n4-color fs-eight">Tutorials</span>
                    </div>
                    <h4 class="blog-title fs-five n5-color fw-semibold">
              ...
              >
                <a href="blog_details.html" class="blog-card">
                  ...
                  <div class="pt-4 pt-md-8 px-3 px-md-5">
                    <div class="d-flex align-items-center gap-3 mb-2 mb-md-3">
                      <span class="n4-color fs-eight">April 13, 2024</span>
                      <span class="p1-color fs-eight">/</span>
                      <span class="n4-color fs-eight">Articles</span>
                    </div>
                    <h4 class="blog-title fs-five n5-color fw-semibold">
              ...
              >
                <a href="blog_details.html" class="blog-card">
                  ...
                  <div class="pt-4 pt-md-8 px-3 px-md-5">
                    ...
                    <h4 class="blog-title fs-five n5-color fw-semibold">
                      new How to Build Desktop Apps with HTML, CSS and JavaScript
                    </h4>
                  </div>
                </a>
              </div>
            ...
            <div
              data-aos="zoom-in-up"
              class="d-flex gap-4 gap-md-8 justify-content-center mt-8 mt-md-15"
            >
